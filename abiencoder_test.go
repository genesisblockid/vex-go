...
var abiData = []byte(`{
	...
	"struct_1_field_1": Name("genesisblockid"),
	"struct_1_field_2": M{
...
func TestABI_Write(t *testing.T) {
	testCases := []map[string]interface{}{
		...
		{"caseName": "Name", "typeName": "name", "expectedValue": "0000000000ea3055", "json": "{\"testField\":\"vexcore\"}", "expectedError": nil},
		...
		{"caseName": "extended_asset", "typeName": "extended_asset", "expectedValue": "0a0000000000000004454f5300000000202932c94c833055", "json": "{\"testField\":{\"quantity\":\"0.0010 EOS\",\"contract\":\"genesisblockid\"}}", "expectedError": nil},
		{"caseName": "extended_asset err", "typeName": "extended_asset", "expectedValue": "", "json": "{\"testField\":{\"quantity\":\"abc.0010 EOS\",\"contract\":\"genesisblockid\"}}", "expectedError": fmt.Errorf("writing field: extended_asset: strconv.ParseInt: parsing \"abc0010\": invalid syntax")},
